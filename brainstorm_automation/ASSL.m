...
% notch_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},file_dir,'*_notch.mat*');
% 
%     if ~isempty(dir(notch_path))
%         continue
%     end
...
% notch_dir = strcat(names.file_name{i},'_notch');
% 
% notch_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},notch_dir,'*_notch.mat*');
% 
%     if ~isempty(dir(notch_path))
%         continue
%     end
...
% notch_band_dir = strcat(names.sub_name{i},'_bandpass');
% 
% path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},notch_band_dir ,'*_notch_band.mat*');
% 
%     if ~isempty(dir(path))
%         continue
%     end

%   notch_dir = strcat(names.sub_name{i},'_notch');
%   notch_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},notch_dir,'*notch.mat');
% 
% Data_dir = dir(notch_path);
% Data_name = {Data_dir.name}; 
% path = fullfile(names.sub_name{i},notch_dir,Data_name);
...
%     event_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name,names.new_event_name,'*data*');
% 
%         if ~isempty(dir(event_path))
%             continue
%         end

%   band_dir = strcat(names.sub_name{i},'_bandpass');
%   band_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},band_dir,'*band.mat*');
% 
% Data_dir = dir(band_path);
% Data_name = {Data_dir.name};
% path = fullfile(names.sub_name{i},band_dir,Data_name);
...
%     event_detrend_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name,names.new_event_name,'*detrend.mat*');
% 
%         if ~isempty(dir(event_detrend_path))
%             continue
%         end
...
% data_name = strcat('*data_',names.old_event_names{j},'*');
% data_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},names.new_event_names{j},data_name);
% 
% if isempty(dir(data_path))
% continue
% end
% 
% sFiles_dir = dir(data_path);
% sFiles_name = {sFiles_dir.name};
% sFiles_path = {fullfile(names.sub_name{i},names.new_event_names{j})};
% sFiles_path = repelem(sFiles_path,length(sFiles_name));
% sFiles = fullfile(sFiles_path,sFiles_name); 
...
%     event_average_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name,names.new_event_name,'*average*');
% 
%         if ~isempty(dir(event_average_path))
%             continue
%         end
...
% data_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},names.new_event_names{j},'*detrend*');
% 
% if isempty(dir(data_path))
% continue
% end
...
% state_name = strcat(names.state_names{1},'_raw');
% 
% headmodel_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.all_sub_names{1},state_name,'headmodel*');
% 
%         if ~isempty(dir(headmodel_path))
%             continue
%         end
...
% data_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},names.new_event_names{j},'*average*');
...
% Data_name = {Data_dir.name}; 
% path = fullfile(names.sub_name{i},names.new_event_names{j},Data_name);
% 
% sFiles = path;
...
% dSPM_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name,names.new_event_names{j},'*dSPM*');
% 
%         if ~isempty(dir(dSPM_path))
%             continue
%         end
...
%     FFT_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name,SA_states{i},'*timefreq_fft*');
% 
%         if ~isempty(dir(FFT_path))
%             continue
%         end
...
%     extracted_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name,SA_states{i},'*concat*');
% 
%         if ~isempty(dir(extracted_path))
%             continue
%         end
...
% data_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name{i},names.new_event_names{j},'*timefreq_fft*');
% 
% if isempty(dir(data_path))
% continue
% end
...
%     diff = strcat(in.events{1},'-',in.events{2});
%     diff_path = fullfile(names.brainstorm_db,names.ProtocolName,'data',...
%     names.sub_name,diff,'*timefreq*');
% 
%         if ~isempty(dir(diff_path))
%             continue
%         end
